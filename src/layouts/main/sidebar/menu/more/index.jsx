...
export default function More() {
  return (
    <>
      {/* Popoverı headlessui sitesinden aldım. Önce bu dosayama ekledim. */}
      <Popover className="relative">
        ...
        <Popover.Panel className="w-[318px] absolute bottom-0 bg-black left-0 shadow-box rounded-xl">
          ...
          <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
            <div className="w-[26.25px] h-[26.25px] relative">
              <svg viewBox="0 0 24 24" width={26.25} height={26.25}><path
                fill="#e7e9ea"
                d="M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9 3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0 1.1.9 2 2 2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4 4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0 4h2c0-1.1-.9-2-2-2v2z" /></svg>
            </div>
            <div className="pr-4 text-xl font-bold">
              Para Kazanma
            </div>
          ...
          <Disclosure>
            ...
            {/*İçerik Üretici Stüdyosu İçindeki yazı */}
            <Disclosure.Panel className="text-gray-500">
              <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white">
                <svg viewBox="0 0 24 24 " width={18.75} height={18.75}>
                  <path
                    fill="currentColor"
          ...
          <Disclosure>
            ...
            {/*Profesyonel Araçlar İçindeki yazı */}
            <Disclosure.Panel className="text-gray-500">
              <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white">
                <svg viewBox="0 0 24 24 " width={18.75} height={18.75}>
                  <path
            ...
            <Disclosure>
              <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover:bg-[#eff3f41a]transition-colors ">
                Ayarlar ve Destekler
                <svg viewBox="0 0 24 24 " width={18.75} height={18.75}>
                  <path
                    fill="currentColor"
                    d="M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z" /></svg>
              </Disclosure.Button>
              {/*Ayarlar ve Destekler İçindeki yazı */}
              <Disclosure.Panel className="text-gray-500">
                <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white">
                  <svg viewBox="0 0 24 24 " width={18.75} height={18.75}>
                    <path
