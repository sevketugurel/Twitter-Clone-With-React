    ...
    icon: {
      active: (
        <svg viewBox="0 0 24 24" ><path
          fill="#fff"
          d="M1.998 4.499c0-.828.671-1.499 1.5-1.499h17c.828 0 1.5.671 1.5 1.499v2.858l-10 4.545-10-4.547V4.499zm0 5.053V19.5c0 .828.671 1.5 1.5 1.5h17c.828 0 1.5-.672 1.5-1.5V9.554l-10 4.545-10-4.547z" /></svg>),
      passive: (
        <svg viewBox="0 0 24 24"><path
          fill="#e7e9ea"
          d="M1.998 5.5c0-1.381 1.119-2.5 2.5-2.5h15c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5h-15c-1.381 0-2.5-1.119-2.5-2.5v-13zm2.5-.5c-.276 0-.5.224-.5.5v2.764l8 3.638 8-3.636V5.5c0-.276-.224-.5-.5-.5h-15zm15.5 5.463l-8 3.636-8-3.638V18.5c0 .276.224.5.5.5h15c.276 0 .5-.224.5-.5v-8.037z" /></svg>)
    }
  },
  {
    path: "/lists",
    ...
    icon: {
      active: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><g><path
          fill="#e7e9ea"
          d="M18.5 2h-13C4.12 2 3 3.12 3 4.5v15C3 20.88 4.12 22 5.5 22h13c1.38 0 2.5-1.12 2.5-2.5v-15C21 3.12 19.88 2 18.5 2zM16 14H8v-2h8v2zm0-4H8V8h8v2z"></path></g></svg>),
      passive: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><g><path
          fill="#e7e9ea"
          d="M3 4.5C3 3.12 4.12 2 5.5 2h13C19.88 2 21 3.12 21 4.5v15c0 1.38-1.12 2.5-2.5 2.5h-13C4.12 22 3 20.88 3 19.5v-15zM5.5 4c-.28 0-.5.22-.5.5v15c0 .28.22.5.5.5h13c.28 0 .5-.22.5-.5v-15c0-.28-.22-.5-.5-.5h-13zM16 10H8V8h8v2zm-8 2h8v2H8v-2z"></path></g></svg>)
    }
  },
  {
    path: "/yer-isaretleri",
    ...
    icon: {
      active: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><g><path
          fill="#e7e9ea"
          d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5z"></path></g></svg>),
      passive: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><g><path
          fill="#e7e9ea"
          d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"></path></g></svg>)
    }
  },
  {
    path: "/topluluklar",
    ...
    icon: {
      active: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><path
          ...
          fill="#fff"
          d="M17.863 13.44c1.477 1.58 2.366 3.8 2.632 6.46l.11 1.1H3.395l.11-1.1c.266-2.66 1.155-4.88 2.632-6.46C7.627 11.85 9.648 11 12 11s4.373.85 5.863 2.44zM12 2C9.791 2 8 3.79 8 6s1.791 4 4 4 4-1.79 4-4-1.791-4-4-4z"/></svg>),
      passive: (
        <svg viewBox="0 0 24 24" width={26.25} height={26.25}><path
          fill="#e7e9ea"
